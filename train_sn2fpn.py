...
import slimneck_v2.for_fpn.fpnpytorch._init_paths
import os
import sys
import numpy as np
import argparse
...
from slimneck_v2.for_fpn.fpnpytorch.lib.roi_data_layer.roidb import combined_roidb
from slimneck_v2.for_fpn.fpnpytorch.lib.roi_data_layer.roibatchLoader import roibatchLoader
from slimneck_v2.for_fpn.fpnpytorch.lib.model.utils.config import cfg, cfg_from_file, cfg_from_list, get_output_dir
from slimneck_v2.for_fpn.fpnpytorch.lib.model.utils.net_utils import weights_normal_init, save_net, load_net, \
      adjust_learning_rate, save_checkpoint, clip_gradient
from slimneck_v2.for_fpn.fpnpytorch.lib.model.fpn.resnet import resnet
...
def parse_args():
  ...
  parser.add_argument('--dataset', dest='dataset', help='training dataset', default='pascal_voc', type=str)  # pascal_voc/coco/vg
  parser.add_argument('--net', dest='net', help='res101, res152, etc', default='res50', type=str)  # recommend res18/34/50
...
if __name__ == '__main__':
  ...
  if args.use_tfboard:
    from slimneck_v2.for_fpn.fpnpytorch.lib.model.utils.logger import Logger
    # Set the logger
    logger = Logger('./logs')
